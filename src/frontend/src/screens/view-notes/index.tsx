...
import { showEditNoteModal } from "../../redux/modules/modal/actions";
...
export const ViewNotes: React.FC = () => {
  ...
  const showEditModal = () => {
    dispatch(showEditNoteModal(true));
  };
  ...
  return (
    <>
      ...
      <FloatingButton title="Edit note" label="edit" placement="left" onClick={showEditModal}>
        <Edit />
      </FloatingButton>
    </>
  );
