...
export const fetchNotesRequestSuccess = createAction<Notes>("@CUSTOMER/FETCH_NOTES_API_SUCCESS");
...
export const fetchNoteRequestSuccess = createAction<Note>("@CUSTOMER/FETCH_NOTE_API_SUCCESS");
